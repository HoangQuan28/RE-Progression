...
- [x] Use a dedicated analysis directory.
- [x] Keep original samples separate from modified files.
- [x] Use a disposable VM for unknown or suspicious binaries.
- [x] Take a VM snapshot before execution.
- [x] Disconnect networking when analyzing suspicious software.
- [x] Do not run unknown binaries as root or administrator.
- [x] Record the operating system, architecture, and tool versions.

### 1.2 Platform Preparation

- [x] Confirm that the target can run in your environment.
- [x] Install required compatibility libraries.
...
- [x] **Ghidra** — free, cross-platform, good decompiler.
...
- [x] Identify the architecture.
- [x] Identify the operating system or runtime.
- [x] Determine whether the file is executable, a library, firmware, or an archive.
- [x] Check whether symbols are present.
...
- [x] Run `file`.
- [x] Run `strings`.
- [x] Search strings for useful clues.
- [x] Inspect the raw bytes.
- [x] Note suspicious sections or embedded files.
- [x] Look for prompts, success messages, error messages, URLs, filenames, and algorithm names.
...
- [x] Stripped or unstripped symbols.
...
- [x] Make a copy of the original.
- [x] Confirm the environment is isolated.
- [x] Decide whether networking is required.
- [x] Record the expected command-line arguments.
- [x] Prepare a harmless test input.
- [x] Avoid using real credentials or personal files.
...
- [x] Import the binary into Ghidra or your chosen tool.
- [x] Select the correct language and architecture.
- [x] Run auto-analysis.
- [x] Save a project copy.
- [x] Record the image base and entry point.
